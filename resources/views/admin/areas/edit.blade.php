{{--
|--------------------------------------------------------------------------
| Admin - Edit Area Page
|--------------------------------------------------------------------------
| Form to edit an existing area.
--}}

@extends('layouts.app')

@section('title', 'Edit Area - GymPass Portal')
    ...
    <div class="row">
        ...
        <div class="col-md-10 main-content">
            ...
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h2 class="fw-bold">
                    <i class="bi bi-pencil text-warning"></i> Edit Area
                </h2>
            ...
            <div class="card shadow-sm">
                <div class="card-body p-4">
                    ...
                    {{--
                    | Form action points to update route with area id
                    | method is POST but we add @method('PUT') to
                    ...
                    <form action="{{ route('admin.areas.update', $area->id) }}" method="POST">
                        ...
                        <div class="mb-3">
                            ...
                            <input
                                ...
                                {{-- Show current area name as default value --}}
                        ...
                        <div class="d-flex gap-2">
                            <button type="submit" class="btn btn-warning btn-lg">
                                <i class="bi bi-check-circle"></i> Update Area
                            </button>
