{{--
|--------------------------------------------------------------------------
| Admin - Create Gym Page
|--------------------------------------------------------------------------
| Form to add a new gym.
| Admin selects area and gym owner from dropdowns.
--}}

@extends('layouts.app')

@section('title', 'Add Gym - GymPass Portal')
    ...
    <div class="row">
        ...
        <div class="col-md-10 main-content">
            ...
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h2 class="fw-bold">
                    <i class="bi bi-plus-circle text-primary"></i> Add New Gym
                </h2>
                    ...
                    <form action="{{ route('admin.gyms.store') }}" method="POST">
                        ...
                        <div class="d-flex gap-2">
                            <button type="submit" class="btn btn-primary btn-lg">
                                <i class="bi bi-check-circle"></i> Save Gym
                            </button>
